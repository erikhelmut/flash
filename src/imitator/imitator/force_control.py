...
class ForceControl(Node):
    ...
    def __init__(self):
        ...
        self.pid = PID(0.01, 0, 0, setpoint=0.0, sample_time=None, starting_output=0.0, output_limits=(-80, 80))
        ...
        self.current_force_subscriber = self.create_subscription(Image, "nta_left", self.get_current_force, current_force_subscriber_qos_profile)
    ...
    def get_current_force(self, msg):
        ...
        # store current force
        self.current_force = np.sum(np.asarray(msg.data))
        print("Current force: ", self.current_force)
